...
public class ClothRepositoryImpl {
    // 이 부분도 Spring data jpa를 쓰면 @Autowired로 대체할 수 있어서 롬북을 쓸 수 있음
    @Autowired
    ...
    public List<Cloth> findSearchAll(String clothName
            , Brand brand, Long mainCategoryId, Long subCategoryId
            , List<String> icons) {
