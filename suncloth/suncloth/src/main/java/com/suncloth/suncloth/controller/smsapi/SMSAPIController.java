package com.suncloth.suncloth.controller.smsapi;
...
public class SMSAPIController {
    ...
    public SMSAPIController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSXL49FJKJHVXNX", "5TIUTT1U0AHT7ZCVDWX83O3GEAC9WPBQ", "https://api.coolsms.co.kr");
    }
     ...
     * 단일 메시지 발송 예제
     */
    @GetMapping("/send-one/{phoneNumber}")
    public String sendOne(@PathVariable String phoneNumber) {
        Message message = new Message();
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        message.setFrom("01087999227"); // 사이트에 등록된 발신번호로 입력해주어야 함
        message.setTo(phoneNumber);

        // Random Key 생성(인증번호 생성)
        ...
        System.out.println("한글 45자, 영자 90자 이하 입력되면 자동으로 SMS타입의 메시지가 추가됩니다.");
